% cifti_regress_nuisance(incifti,nreg,aggressive,outcifti)
%
% version 1.0, 5/17/17
...
%
% incifti = input cifti data (.*.nii)
% nreg = input nuisance regressor data (.mat) % will add .txt/.csv support later
...
%% declare function
function cifti_regress_nuisance.m(incifti,nreg,aggressive,outcifti)
